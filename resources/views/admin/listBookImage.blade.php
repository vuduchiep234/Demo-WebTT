    ...
    <!-- Main content -->
        ...
        <div class="box">
            <div class="box-header">
                ...
                <button class="btn btn-sm btn-success" data-toggle="modal" data-target="#myModal-BookImage" id="addBookImage" style="float: right;">
                    <i class=" "></i>
                    Add
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td class="text-center">
                      <a href="#" class="text-blue edit-role" data-toggle="modal" data-target="#editModal-BookImage">
                        <i class="ace-icon fa fa-pencil bigger-130"></i>
                      </a>
                    </td>
                    <td class="text-center">
                      <a class="text-red" href="#" data-toggle="modal" data-target="#deleteModal-BookImage">
...
<div class="modal fade" id="myModal-BookImage" role="dialog">
        ...
        <form action="" method="get" id="form-member">
            ...
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <h4 class="modal-title">Add Book Image</h4>
                </div>
...
<div class="modal fade" id="editModal-BookImage" role="dialog">
    <div class="modal-dialog">
        ...
        <form method="get" action="">
            ...
            <div class="modal-content">
                <div class="modal-header">
                    <button type="button" class="close" data-dismiss="modal">&times;</button>
                    <h4 class="modal-title">Edit Book Image</h4>
                </div>
                <div class="modal-body">
                    <div class="row">
                        <div class="col-xs-12">
...
<div class="modal fade" id="deleteModal-BookImage" role="dialog">
    <div class="modal-dialog">
