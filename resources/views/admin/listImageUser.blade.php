    ...
    <!-- Main content -->
        ...
        <div class="box">
            <div class="box-header">
                <h3 class="box-title"><b>List Image User</b></h3>
                <button class="btn btn-sm btn-success" data-toggle="modal" data-target="#myModal-ImageUser" id="addImageUser" style="float: right;">
                    <i class=" "></i>
                    Add
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td class="text-center">
                      <a href="#" class="text-blue edit-role" data-toggle="modal" data-target="#editModal-ImageUser">
                        <i class="ace-icon fa fa-pencil bigger-130"></i>
                      </a>
                    </td>
                    <td class="text-center">
                      <a class="text-red" href="#" data-toggle="modal" data-target="#deleteModal-ImageUser">
...
<div class="modal fade" id="myModal-ImageUser" role="dialog">
        ...
        <form action="" method="get" id="form-member">
            ...
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <h4 class="modal-title">Add Image User</h4>
                </div>
                <div class="modal-body">
                    <div class="row">
                        <div class="col-xs-12">
                            ...
                            <div class="col-sm-11" style="margin-top: 5px;">
                                <div class="form-group">
                                    <label class="control-label col-xs-12 col-sm-3 no-padding-right" for="password2" style="margin-top: 5px;">Image ID:</label>
...
<div class="modal fade" id="editModal-ImageUser" role="dialog">
    <div class="modal-dialog">
        ...
        <form method="get" action="">
            ...
            <div class="modal-content">
                <div class="modal-header">
                    <button type="button" class="close" data-dismiss="modal">&times;</button>
                    <h4 class="modal-title">Edit Image User</h4>
                </div>
                <div class="modal-body">
                    <div class="row">
                        <div class="col-xs-12">
...
<div class="modal fade" id="deleteModal-ImageUser" role="dialog">
    <div class="modal-dialog">
