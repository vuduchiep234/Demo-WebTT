    ...
    <!-- Main content -->
        ...
        <div class="box">
            <div class="box-header">
                <h3 class="box-title"><b>List Book Copy</b></h3>
                <button class="btn btn-sm btn-success" data-toggle="modal" data-target="#myModal-BookCopy" id="addBookCopy" style="float: right;">
                    <i class=" "></i>
                    Add
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td class="text-center">
                      <a href="#" class="text-blue edit-role" data-toggle="modal" data-target="#editModal-BookCopy">
                        <i class="ace-icon fa fa-pencil bigger-130"></i>
                      </a>
                    </td>
                    <td class="text-center">
                      <a class="text-red" href="#" data-toggle="modal" data-target="#deleteModal-BookCopy">
...
<div class="modal fade" id="myModal-BookCopy" role="dialog">
        ...
        <form action="" method="get" id="form-member">
            ...
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <h4 class="modal-title">Add Book Copy</h4>
                </div>
...
<div class="modal fade" id="editModal-BookCopy" role="dialog">
    <div class="modal-dialog">
        ...
        <form method="get" action="">
            ...
            <div class="modal-content">
                <div class="modal-header">
                    <button type="button" class="close" data-dismiss="modal">&times;</button>
                    <h4 class="modal-title">Edit Book Copy</h4>
                </div>
                <div class="modal-body">
                    <div class="row">
                        <div class="col-xs-12">
...
<div class="modal fade" id="deleteModal-BookCopy" role="dialog">
    <div class="modal-dialog">
