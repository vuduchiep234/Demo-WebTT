    ...
    <!-- Main content -->
        ...
        <div class="box">
            <div class="box-header">
                ...
                <button class="btn btn-sm btn-success" data-toggle="modal" data-target="#myModal-image" id="addImage" style="float: right;">
                    <i class=" "></i>
                    Add
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td class="text-center">
                      <a href="#" class="text-blue edit-role" data-toggle="modal" data-target="#editModal-image">
                        <i class="ace-icon fa fa-pencil bigger-130"></i>
                      </a>
                    </td>
                    <td class="text-center">
                      <a class="text-red" href="#" data-toggle="modal" data-target="#deleteModal-image">
                ...
                <div class="modal-body">
                    <div class="row">
                        <div class="col-xs-12">
                            ...
                            <div class="col-sm-9" >
                                <div class="form-group" >
                                    <label class="col-sm-4 control-label no-padding-right" for="form-field-1" style="margin-top: 22px;">URL:</label>
